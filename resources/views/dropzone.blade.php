            ...
            <div class="col-lg-8 offset-lg-2">
                <div class="form-wrapper py-5">
                    ...
                    <form action="{{ route('form.data') }}" name="demoform" id="demoform" method="POST" class="dropzone" enctype="multipart/form-data">
                        ...
                        @csrf
                        <input type="text" class="category_id" name="category_id" id="category_id" value="">
                        <input type="text" class="main_image" name="main_image" id="main_image" value="">
                        ...
                        <div class="form-group">
                            ...
                            <label for="image_title">image_title</label>
                            <input type="text" name="image_title" id="name" placeholder="Enter your image_title" class="form-control" required autocomplete="off">
                        </div>
                        <div class="form-group">


                            <label for="journalist_name">journalist_name</label>
                            <input type="text" name="journalist_name" id="journalist_name" placeholder="Enter your journalist_name" class="form-control" required autocomplete="off">
                        </div>
                        <div class="form-group">


                            <label for="editor">editor</label>
                            <input type="text" name="editor" id="editor" placeholder="Enter your editor" class="form-control" required autocomplete="off">
                        </div>
                        <div class="form-group">


                            <label for="tags">tags</label>
                            <input type="text" name="tags" id="name" placeholder="Enter your tags" class="form-control" required autocomplete="off">
                        </div>
