<!DOCTYPE html>
<html @if(App::getLocale()=='en') lang="en" @else lang="ar" dir="rtl" @endif>
<head>
    <meta charset="UTF-8" />
...
<body>
<!-- ======== sidebar-nav start =========== -->
<aside class="sidebar-nav-wrapper  @if(App::getLocale() == 'ar') text-align-right  @endif">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-6">
                    ...
                    <div class="header-right">
                        ...
                        <!----------------------language swithcer --------------------------->
                        <div class="header-message-box ml-15 d-none d-md-flex">
                            <button  class="dropdown-toggle" type="button" id="message2" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="lni lni-chevron-down"></i>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message2">
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                    <li @if( LaravelLocalization::getCurrentLocaleNative() == $properties['native']) class="bg-info" @endif>
                                        <div class="content">
